...
export default function MobileFilter({ setIsMobileFilterOpen, currentDate, setCurrentDate, currentMonth, setCurrentMonth, filteredEvents, selectedRooms, setSelectedRooms }: MobileFilterProps) {
  return (
