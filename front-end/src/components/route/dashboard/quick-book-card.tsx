...
export default function QuickBookCard({ handleAddClick }: { handleAddClick: (open: boolean) => void }) {
  return (
    <div 
      ...
      className="flex-1 bg-linear-to-br from-dark-purple to-dark-purple/70 rounded-2xl p-8 shadow-xl shadow-[#8370ff]/20 flex flex-col items-center justify-center text-center cursor-pointer hover:brightness-110 hover:-translate-y-1 transition-all group">
