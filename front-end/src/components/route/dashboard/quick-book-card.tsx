...
export default function QuickBookCard({ setIsAddModalOpen }: { setIsAddModalOpen: (open: boolean) => void }) {

  return (
    <div 
      onClick={() => setIsAddModalOpen(true)}
      className="flex-1 bg-linear-to-br from-[#8370ff] to-[#6b56f6] rounded-2xl p-8 shadow-xl shadow-[#8370ff]/20 flex flex-col items-center justify-center text-center cursor-pointer hover:brightness-110 hover:-translate-y-1 transition-all group">
