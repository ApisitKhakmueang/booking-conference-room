...
export default function OverviewCard({ events } : { events?: BookingEvent[]}) {
  return (
    <div className="w-[222px] hidden xl:block">
      <Card loading={false} className="py-0 border bg-light-sidebar border-dark-purple/30 shadow-sm dark:bg-card dark:border-transparent duration-0 w-full overflow-hidden rounded-none">
